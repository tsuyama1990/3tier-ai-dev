...
class TestModuleDisplay(unittest.TestCase):
    ...
    def test_submodule(self):
        ...
        self.assertEqual(_module_display("ase", "ase.calculators.emt"), "ase.calculators.emt")
...
class TestGenerateIntegrationGraph(unittest.TestCase):
    ...
    def test_includes_expected_sections(self):
        ...
        output = generate_integration_graph(self.index, self.report, Path("/tmp"), "ase")
...
class TestCLI(unittest.TestCase):
    ...
    def test_main_manifest_mode(self):
        ...
        (cache_dir / "verified_examples" / "test.py").write_text("import ase\n", encoding="utf-8")
        # Write report
...
class TestEdgeCases(unittest.TestCase):
    ...
    def test_api_entry_module_extraction(self):
        ...
        entry = ApiEntry(fqn="ase.calculators.emt.EMT", module="ase.calculators.emt", name="EMT")
